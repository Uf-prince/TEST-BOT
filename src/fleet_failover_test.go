...
func TestFleetServerNumberForSIDTable(t *testing.T) {
	// NOTE: servers.json owner ne baad me edit kiya (bdf1046). Ye cases
	// current servers.json ke URLs se match karte hain (SERVER 1/5/14).
	cases := []struct{ sid, want string }{
		{"", "0"},
		{"https://gold-md-xsvrr36.onrender.com", "1"},
		{"gold-md-xsvrr36.onrender.com", "1"},
		{"https://gold-md-xsvrr38.onrender.com/", "5"},
		{"https://gold-md-xsvrr42.onrender.com/", "14"},
