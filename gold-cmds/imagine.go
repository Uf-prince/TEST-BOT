...
func init() {
	Register(Command{Name: "imagine", Category: "AI & MEDIA", Desc: "THIS COMMAND IS USED TO MAKE AN AI IMAGE FROM YOUR TEXT. TYPE ANY WORDS AND THE BOT MAKES A PICTURE FOR YOU.", Run: handleImagine})
