...
var goldSettingsList = []settingsEntry{
	...
	{t: "AI MODE ON", c: "aimode on"},
	{t: "AI MODE OFF", c: "aimode off"},
	{t: "AI MODE PREFIX (WAKE-WORD) SET", c: "aimode prefix", ask: "SEND THE NEW AI MODE WAKE-WORD",
		ex:  "SEND ONLY ONE WORD, NO SYMBOLS.\n*EXAMPLE ❮ BILAL ❯*",
		why: "AI MODE WILL ONLY REACT TO MESSAGES THAT START WITH THIS WORD."},
