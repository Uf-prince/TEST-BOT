...
func init() {
	...
	Register(Command{Name: "mute", Category: "GROUP MANAGEMENT", Desc: "THIS COMMAND IS USED TO MUTE THE GROUP. ONLY ADMINS CAN SEND MESSAGES WHEN IT IS ON.", OwnerOnly: true, Run: handleMute})
	Register(Command{Name: "unmute", Category: "GROUP MANAGEMENT", Desc: "THIS COMMAND IS USED TO UNMUTE THE GROUP SO ALL MEMBERS CAN SEND MESSAGES.", OwnerOnly: true, Run: handleUnmute})
	Register(Command{Name: "kick", Category: "GROUP MANAGEMENT", Desc: "THIS COMMAND IS USED TO REMOVE A MEMBER FROM THE GROUP. REPLY TO THE MEMBER OR TAG THEM.", OwnerOnly: true, Run: handleKick})
	Register(Command{Name: "promote", Category: "GROUP MANAGEMENT", Desc: "THIS COMMAND IS USED TO MAKE A GROUP MEMBER AN ADMIN. REPLY TO THE MEMBER OR TAG THEM.", OwnerOnly: true, Run: handlePromote})
	Register(Command{Name: "demote", Category: "GROUP MANAGEMENT", Desc: "THIS COMMAND IS USED TO REMOVE ADMIN POWER FROM A GROUP MEMBER. REPLY TO THE MEMBER OR TAG THEM.", OwnerOnly: true, Run: handleDemote})
	Register(Command{Name: "invitelink", Category: "GROUP MANAGEMENT", Desc: "THIS COMMAND IS USED TO SHOW THE GROUP INVITE LINK.", OwnerOnly: true, Run: handleInviteLink})
	Register(Command{Name: "revokelink", Category: "GROUP MANAGEMENT", Desc: "THIS COMMAND IS USED TO RESET THE GROUP INVITE LINK AND GET A NEW ONE.", OwnerOnly: true, Run: handleRevokeLink})
	Register(Command{Name: "gname", Category: "GROUP MANAGEMENT", Desc: "THIS COMMAND IS USED TO CHANGE THE GROUP NAME. USE IT WITH THE NEW NAME.", OwnerOnly: true, Run: handleSetGName})
	Register(Command{Name: "gdesc", Category: "GROUP MANAGEMENT", Desc: "THIS COMMAND IS USED TO CHANGE THE GROUP DESCRIPTION. USE IT WITH THE NEW DESCRIPTION TEXT.", OwnerOnly: true, Run: handleSetGDesc})
	Register(Command{Name: "members", Category: "GROUP MANAGEMENT", Desc: "THIS COMMAND IS USED TO SHOW THE LIST OF ALL MEMBERS OF THE GROUP.", OwnerOnly: true, Run: handleMembers})
	Register(Command{Name: "groupinfo", Category: "GROUP MANAGEMENT", Desc: "THIS COMMAND IS USED TO SHOW FULL DETAILS OF THE GROUP LIKE NAME, ADMINS, MEMBERS AND LINK.", OwnerOnly: true, Run: handleGroupInfo})
	Register(Command{Name: "tagall", Category: "GROUP MANAGEMENT", Desc: "THIS COMMAND IS USED TO TAG ALL MEMBERS OF THE GROUP IN ONE MESSAGE.", OwnerOnly: true, Run: handleTagAll})
	Register(Command{Name: "tagadmins", Category: "GROUP MANAGEMENT", Desc: "THIS COMMAND IS USED TO TAG ALL ADMINS OF THE GROUP IN ONE MESSAGE.", OwnerOnly: true, Run: handleTagAdmin})
	Register(Command{Name: "leave", Category: "GROUP MANAGEMENT", Desc: "THIS COMMAND IS USED TO MAKE THE BOT LEAVE THE GROUP.", OwnerOnly: true, Run: handleLeave})
	Register(Command{Name: "count", Category: "GROUP MANAGEMENT", Desc: "THIS COMMAND IS USED TO SHOW THE TOTAL MEMBER COUNT OF THE GROUP.", OwnerOnly: true, Run: handleCount})
	Register(Command{Name: "gonline", Category: "GROUP MANAGEMENT", Desc: "THIS COMMAND IS USED TO SHOW ALL ONLINE MEMBERS OF THE GROUP.", OwnerOnly: true, Run: handleOnline})
	Register(Command{Name: "editgc", Category: "GROUP MANAGEMENT", Desc: "THIS COMMAND IS USED TO CHANGE GROUP EDIT SETTINGS. IT CONTROLS WHO CAN EDIT THE GROUP INFO.", OwnerOnly: true, Run: handleEditGC})
	Register(Command{Name: "lockgc", Category: "GROUP MANAGEMENT", Desc: "THIS COMMAND IS USED TO LOCK THE GROUP SO NEW MEMBERS NEED ADMIN APPROVAL TO JOIN.", OwnerOnly: true, Run: handleLockGC})
	...
	Register(Command{Name: "goodbye", Desc: "THIS COMMAND IS USED TO SET AND CONTROL GOODBYE MESSAGES FOR MEMBERS WHO LEAVE THE GROUP.", OwnerOnly: true, Hidden: true, Run: handleLeave})
